...
router.get('/', function (req, res) {
    var data = {
        title: 'NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'index'
    };
...
router.get('/ticket', function (req, res) {
    var data = {
        title: 'Ticket | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'ticket'
    };
...
router.get('/speakers', function (req, res) {
    var data = {
        title: 'Speakers | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'speakers'
    };
...
router.get('/partners', function (req, res) {
    var data = {
        title: 'Partners | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'partners'
    };
...
router.get('/call-for-papers', function (req, res) {
    var data = {
        title: 'Call for Papers | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'cfp'
    };
...
router.get('/atevent', function (req, res) {
    var data = {
        title: 'At The Event | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'atevent'
    };
...
router.get('/schedule', function (req, res) {
    var data = {
        title: 'Schedule | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'schedule'
    };
...
router.get('/about', function (req, res) {
    var data = {
        title: 'Who we are | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'about'
    };
...
router.get('/location', function (req, res) {
    var data = {
        title: 'Location | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'location'
    };
...
router.get('/legal', function (req, res) {
    var data = {
        title: 'Legal Information | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'legal'
    };
...
router.get('/coc', function (req, res) {
    var data = {
        title: 'Code Of Conduct | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'coc'
    };
...
router.get('/privacy', function (req, res) {
    var data = {
        title: 'Privacy | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'privacy'
    };

    res.render('lib/views/pages/privacy.html', data);
});

// Event Coverage Routes
router.get('/event', function (req, res) {
    var data = {
        title: 'Event Coverage | NightlyBuild 2018 – Front End Conference in Cologne',
        page: 'coc'
    };
